...
use App\Console\GitHooks\PhpUnitPreCommitHook;
...
return [
    ...
    */
    'pre-commit' => [
        ...
        PintPreCommitHook::class, // Laravel Pint
        PhpInsightsPreCommitHook::class, // PhpInsights
        RectorPreCommitHook::class, // Rector
        PhpUnitPreCommitHook::class, // Php Unit
    ],
    ...
    */
    'code_analyzers' => [
        ...
        'prettier' => [
            ...
            'config' => env('PRETTIER_CONFIG', '.prettierrc'),
        ...
        'eslint' => [
            ...
            'config' => env('ESLINT_CONFIG', '.eslintrc.json'),
